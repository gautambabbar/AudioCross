...
namespace HelloWorld
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            WaveFileReader reader = new WaveFileReader(refAudioFile);
            TimeSpan span = reader.TotalTime;
            double audioLen = refAudioData.Length;
            double spanSecs = (span.Seconds + span.Minutes * 60);
            delay = (maxIndex/audioLen)*spanSecs ;
           ...
           // correlation = normalize(audioData, refAudioData, maxIndex, maxValue);
            ...
            {
                Console.WriteLine("correlation not available at this time. Contact your savior");
            }
            else
            {
